...
function wpas_editor_langs() {
    ...
    $strings = array(
		...
		'window_title' => __('WPAS Template Tags', 'awesome-support'),
		'plugin_long_name' => __('WPAS Email Template Tags', 'awesome-support'),
		'table_header_tag' => __('Tag', 'awesome-support'),
		'table_header_desc' => __('Description', 'awesome-support'),
		'instructions' => __('Select one of the following tags to insert into the email template, at the current cursor location.', 'awesome-support')
    );
