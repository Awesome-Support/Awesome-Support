	...
	$settings = array(
		'registration' => array(
			...
			'options' => array(
				...
				array(
					'name' => __( 'Moderated Registration Settings', 'awesome-support' ),
					'type' => 'heading'
				),
				
				array(
					'name'    => __( 'Default User Role While a Registration Request is Waiting', 'awesome-support' ),
					'id'      => 'moderated_pending_user_role',
					'type'    => 'text',
					'desc'    => __( 'The role should be the internal WordPress role id such as wpas_user and is case sensitive.', 'awesome-support' ),
					'default' => ''
				),
				
				array(
					'name'    => __( 'Default User Role when Moderated User Activated', 'awesome-support' ),
					'id'      => 'moderated_activated_user_role',
					'type'    => 'text',
					'desc'    => __( 'The role should be the internal WordPress role id such as wpas_user and is case sensitive.  Do not leave this blank.', 'awesome-support' ),
					'default' => 'wpas_user'
				),
				...
				array(
					...
					'type' => 'heading',
					'desc' => __( 'Notify admin and user about moderated registration', 'awesome-support' ),
				),
				
                array(
                        'name'    => __( 'Admin Email', 'awesome-support' ),
                        'type'    => 'heading'
                ),
				...
				array(
                        ...
                        'type'    => 'checkbox',
                        'default' => true,
                        'desc'    => __( 'Send email to admin about new moderated registration', 'awesome-support' )
                ),
