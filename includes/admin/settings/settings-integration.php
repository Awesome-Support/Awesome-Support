		...
		'integration' => array(
			...
			'options' => array(
				...
				array(
					...
					'type'    => 'text',
					'desc'    => __( 'What is the myCRED Meta Key that should be used to record points for agents?  See the myCRED setings screen and documentation for more information', 'awesome-support' ),					
					'default' => false,
				),
				array(
				...
				array(
					...
					'type'    => 'number',
					'desc'    => __( 'How many point should an agent get when they close a ticket?', 'awesome-support' ),					
					'default' => 1,
				),
				array(
				...
				array(
					...
					'type'    => 'text',
					'desc'    => __( 'What is the myCRED Meta Key that should be used to record points for users?  See the myCRED setings screen and documentation for more information', 'awesome-support' ),					
					'default' => false,
				),				
				array(
					...
					'type'    => 'number',
					'desc'    => __( 'How many point should a user get when they submit or open a ticket?', 'awesome-support' ),					
					'default' => 1,
				),
				array(
					...
					'type'    => 'number',
					'desc'    => __( 'How many point should a user get when they reply to a ticket?', 'awesome-support' ),					
					'default' => 1,
				),
				array(
					...
					'type'    => 'number',
					'desc'    => __( 'How many point should a user get when they close a ticket?', 'awesome-support' ),					
					'default' => 1,
				),
				array(
