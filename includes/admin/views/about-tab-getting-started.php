<div class="changelog">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<div class="about-body">
				<p><b>If you completed the SETUP wizard then your ticket system is all ready to go so getting started is really simple! If not, here are some key steps to configuring your new support system. </b></p>
	...
	<div class="row">
		<div>			
			<div class="about-body">
				<h1>Tickets, Agents and Users</h1>
				<ol>
