			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="about-body">
					<a class="wpas-bundle-link" href="https://getawesomesupport.com/addons/startup-bundle/" target="_blank">
						<img src="<?php echo esc_url( WPAS_URL ); ?>assets/admin/images/StartupBundle-2_Blue.png" alt="Startup Bundle">
					</a>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="about-body">
					<a class="wpas-bundle-link" href="https://getawesomesupport.com/addons/professional-bundle/" target="_blank">
						<img src="<?php echo esc_url( WPAS_URL ); ?>assets/admin/images/ProfessionalBundle-1_Red.png" alt="Professsional Bundle">
					</a>
				</div>
			</div>
		</div>
