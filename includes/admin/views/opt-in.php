<div class="wrap about-wrap">
	...
	<div class="changelog">
		...
		<p><?php echo sprintf( __( 'Getting your addon is dead simple: just subscribe to our newsletter hereafter and then you will get the free addon by e-mail. We will not spam you. We usually send out newsletters to talk about new major features in Awesome Support, let you know when new addons are being released and provide informative articles that show you how to use Awesome Support to its full potential. <a href="%s" %s>View our privacy policy</a>', 'awesome-support' ), 'https://getawesomesupport.com/legal/privacy-policy/', 'target="_blank"' ) ; ?></p>
