<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="<?php echo add_query_arg( array( 'post_type' => 'ticket', 'page' => 'wpas-status', 'tab' => 'tools' ), admin_url( 'edit.php' ) ); ?>" class="nav-tab <?php if ( isset( $_GET['tab'] ) && 'tools' === $_GET['tab'] ): ?> nav-tab-active<?php endif; ?>"><?php _e( 'Tools', 'wpas' ); ?></a>
	</h2>
