<div class="wrap about-wrap">
	...
	<div class="changelog">
		...
		<div class="row" style="margin-top: 0px;">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="margin-top: 0px;">
				<div class="about-body">
					...
					<p><?php echo sprintf( wp_kses_post( __( '<a href="%s">Open a ticket directly with us</a>', 'awesome-support' ) ), 'https://getawesomesupport.com/submit-ticket', 'target="_blank"' ) ; ?></p>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="margin-top: 0px;">
				<div class="about-body">
					...
					<p><?php echo sprintf( wp_kses_post( __( '<a href="%s">Ask for help on WordPress.org</a>', 'awesome-support' ) ), 'https://wordpress.org/support/plugin/awesome-support/', 'target="_blank"' ) ; ?></p>
				</div>
			</div>
		</div>
		...
		<p><?php echo sprintf( wp_kses_post( __( '<a href="%s">Get started with unlimited fixes with a 10 day trial at ValiusWP.com</a>', 'awesome-support' ) ), 'https://valiuswp.com/', 'target="_blank"' ) ; ?></p>
		...
		<p><?php echo sprintf( wp_kses_post( __( 'Documentation links are located in our <a href="%s">About Page</a>', 'awesome-support' ) ), esc_url( $about_url ), 'target="_blank"' ) ; ?></p>
