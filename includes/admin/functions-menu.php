...
function wpas_register_submenu_items() {
	...
	add_submenu_page( 'edit.php?post_type=ticket', __( 'Get a Free Addon', 'awesome-support' ), '<span style="color:#f39c12;">' . esc_html__( 'Get a Free Addon!', 'awesome-support' ) . '</span>', 'edit_posts', 'wpas-optin', 'wpas_display_optin_page' );
