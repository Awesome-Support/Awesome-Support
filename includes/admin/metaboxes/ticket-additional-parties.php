...
<div class="wpas-ticket-addl-parties-mb">
	...
	if ( isset( $options['multiple_agents_per_ticket'] ) && true === boolval( $options['multiple_agents_per_ticket'] ) ) {
		...
		echo _e( 'Note: These agents do not see this ticket in their normal ticket list. However, they are sometimes notified of normal ticket events via email.', 'awesome-support' );
