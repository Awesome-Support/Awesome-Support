 ...
 */
 ...
 class MUMEI_AYUDA_WC_MyAccount {
	...
	public function new_menu_items( $items ) {
		...
		$my_tickets_label = empty( mumei_ayuda_get_option( 'simple_wc_my_tickets_label' ) ) ? __( 'My tickets', 'ayuda-help-desk' ) :  mumei_ayuda_get_option( 'simple_wc_my_tickets_label' ) ;
		$submit_ticket_label = empty( mumei_ayuda_get_option( 'simple_wc_submit_ticket_label') ) ? __( 'Open a support ticket', 'ayuda-help-desk' ) : mumei_ayuda_get_option( 'simple_wc_submit_ticket_label') ;
		
		// Insert the new menu items (endpoints)
		$items[ $this->endpoint_openticket ] = apply_filters( 'mumei_ayuda_wc_account_tab_name_openticket', $submit_ticket_label );		
		$items[ $this->endpoint_ticketlist ] = apply_filters( 'mumei_ayuda_wc_account_tab_name_ticketlist', $my_tickets_label );
	...
	public function get_endpoint_name_for_ticket_list() {
		...
		$page_id = mumei_ayuda_get_option('ticket_list') ;  // get the id of the ticket_list page from settings...
	...
	public function get_endpoint_name_for_openticket_page() {
		...
		$page_ids = mumei_ayuda_get_option('ticket_submit') ;  // get the ids of the ticket pages from settings...
 ...
 if ( true === boolval( mumei_ayuda_get_option( 'enable_simple_wc', false ) ) ) {	 
	$wcmyaccount = new MUMEI_AYUDA_WC_MyAccount();	 
 }