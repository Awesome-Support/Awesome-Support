...
class WPAS_Product_WP_Ecommerce {
	...
	public function locked_message( $message ) {
		return sprintf( __( 'You cannot edit this term from here because it is linked to a WP eCommerce product. <a href="%s">Please edit the product directly</a>.', 'wpas' ), add_query_arg( 'post_type', 'wpsc-product', admin_url( 'edit.php' ) ) );
	}
