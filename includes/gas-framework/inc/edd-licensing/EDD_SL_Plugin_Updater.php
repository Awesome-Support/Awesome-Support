...
class GASF_EDD_SL_Plugin { // Namespaced to PBS for error protection
	...
	public function show_update_notification( $file, $plugin ) {
		...
		if ( ! empty( $update_cache->response[ $this->name ] ) && version_compare( $this->version, $version_info->new_version, '<' ) ) {
			...
			if ( empty( $version_info->download_link ) ) {
				...
				$x_content = __( 'There is a new version of %1$s available. %2$sView version %3$s details%4$s.', 'ayuda-help-desk' );
				...
				$x_content = __( 'There is a new version of %1$s available. %2$sView version %3$s details%4$s or %5$supdate now%6$s.', 'ayuda-help-desk' );
	...
	public function show_changelog() {
		...
		if( ! current_user_can( 'update_plugins' ) ) {
			wp_die( wp_kses_post(__( 'You do not have permission to install plugin updates', 'ayuda-help-desk' )), wp_kses_post(__( 'Error', 'ayuda-help-desk' )), array( 'response' => 403 ) );
		}
