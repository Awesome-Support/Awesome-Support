...
class gasscssc {
	...
	public function compile($code, $name=null) {
		...
		$this->parser = new gasscss_parser($name);
...
class gasscss_parser {
	...
	static protected function makeOperatorStr($operators) {
		return '('.implode('|', array_map(array('gasscss_parser','preg_quote'),
			$operators)).')';
	}
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class gasscss_formatter_nested extends gasscss_formatter {
	public $close = " }";
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class gasscss_formatter_compressed extends gasscss_formatter {
	public $open = "{";
	public $tagSeparator = ",";
	public $assignSeparator = ":";
	public $break = "";
