 ...
 * @since	1.0
 **/
class GASFrameworkOptionNumber extends GASFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new GASFrameworkOptionNumberControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerGASFrameworkOptionNumberControl', 1 );
 ...
 * @since	1.0
 */
function registerGASFrameworkOptionNumberControl() {
	class GASFrameworkOptionNumberControl extends WP_Customize_Control {
		public $description;
		public $size;
		public $min;
		public $max;
		...
		public function render_content() {
			...
			if ( self::$firstLoad ) {
				GASFrameworkOptionNumber::createSliderScript();
			}
