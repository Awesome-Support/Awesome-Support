...
class GASFrameworkOptionTextarea extends GASFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new GASFrameworkOptionTextareaControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerGASFrameworkOptionTextareaControl', 1 );
function registerGASFrameworkOptionTextareaControl() {
	class GASFrameworkOptionTextareaControl extends WP_Customize_Control {
		public $description;
		public $is_code;
