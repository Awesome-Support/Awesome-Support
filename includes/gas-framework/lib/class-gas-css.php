...
/**
 * GAS Framework CSS Class
 * In charge of creating and parsing CSS rules created from framework options.
 *
 * @author Benjamin Intal
 **/
class GASFrameworkCSS {

	// Compression type to use
	const SCSS_COMPRESSION = 'gasscss_formatter_compressed';
	 ...
	 * Class constructor
	 *
	 * @param   GASFramework $frameworkInstance an instance of the framework object
	 * @return  void
	 * @since   1.2
	 */
	 ...
	 *
	 * @param   GASFrameworkOption $option The option which was just added
	 * @return  void
	 * @since   1.2
	 */
	...
	private function getCSSSlug() {
		return GASF . '-' . str_replace( ' ', '-', trim( strtolower( $this->frameworkInstance->optionNamespace ) ) . '-css' );
	}
	...
	public function generateCSS() {
		...
		// Add additional CSS added via GASFramework::createCSS()
	 ...
	 * the GASFramework->createCSS( '...' ) function.
	 *
	 * @return	void
	 * @since	1.3
	 */
