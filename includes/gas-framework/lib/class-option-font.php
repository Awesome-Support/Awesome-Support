 ...
 * @since	1.4
 */
class GASFrameworkOptionFont extends GASFrameworkOption {
	 ...
	 * @return void
	 *
	 * @see GasFrameworkCustomizer->livePreviewMainScript()
	 */
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new GASFrameworkOptionFontControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerGASFrameworkOptionFontControl', 1 );
 ...
 * @since	1.4
 */
function registerGASFrameworkOptionFontControl() {
	class GASFrameworkOptionFontControl extends WP_Customize_Control {
		public $description;
		public $params;

		public function render_content() {
			GASFrameworkOptionFont::createFontScript();
			...
			$value = array_merge( GASFrameworkOptionFont::$defaultStyling, $value );
