 ...
 * @since	1.4
 **/
class GASFrameworkOptionSortable extends GASFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new GASFrameworkOptionSortableControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerGASFrameworkOptionSortableControl', 1 );
 ...
 * @since	1.4
 */
function registerGASFrameworkOptionSortableControl() {
	class GASFrameworkOptionSortableControl extends WP_Customize_Control {
		public $description;
		public $options;
		public $visible_button;

		public function render_content() {
			GASFrameworkOptionSortable::createSortableScript();
