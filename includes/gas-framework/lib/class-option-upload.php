...
class GASFrameworkOptionUpload extends GASFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new GASFrameworkOptionUploadControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerGASFrameworkOptionUploadControl', 1 );
function registerGASFrameworkOptionUploadControl() {
	class GASFrameworkOptionUploadControl extends WP_Customize_Control {
		public $description;

		public function render_content() {
			GASFrameworkOptionUpload::createUploaderScript();
