...
class GASFrameworkOptionColor extends GASFrameworkOption {
	...
	public function enqueueColorPickerScript() {
		...
		wp_enqueue_script( 'wp-color-picker-alpha', GASFramework::getURL( '../js/min/wp-color-picker-alpha-min.js', __FILE__ ), array( 'wp-color-picker' ), GASF_VERSION );
	}
	 ...
	 * @param GASFrameworkCustomizer $section
	 * @param int                      $priority The location/priority of this option inside the section.
	 *
	 * @return void
	 */
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new GASFrameworkOptionColorControl( $wp_customize, $this->getID(), array(
...
add_action( 'customize_register', 'registerGASFrameworkOptionColorControl', 1 );


function registerGASFrameworkOptionColorControl() {
	class GASFrameworkOptionColorControl extends WP_Customize_Color_Control {
