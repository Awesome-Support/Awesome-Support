	...
	public function createAdminPage() {
		...
		if ( ! empty( $_GET['message'] ) ) {
			if ( $_GET['message'] == 'saved' ) {
				echo wp_kses_post(GASFrameworkAdminNotification::formNotification( __( 'Settings saved.', 'gas-framework' ) ), esc_html( $_GET['message'] ) );
			} else if ( $_GET['message'] == 'reset' ) {
				echo wp_kses_post(GASFrameworkAdminNotification::formNotification( __( 'Settings reset to default.', 'gas-framework' ) ), esc_html( $_GET['message'] ) );
			}
		}
