...
class GASFrameworkOptionRadioPalette extends GASFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new GASFrameworkOptionRadioPaletteControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerGASFrameworkOptionRadioPaletteControl', 1 );
function registerGASFrameworkOptionRadioPaletteControl() {
	class GASFrameworkOptionRadioPaletteControl extends WP_Customize_Control {
		public $description;
