		...
		public function display_install_or_active_notice() {
			...
			if ( ! $this->plugin_exists() ) {
				echo "<div class='error'><p><strong>"
					. esc_html( apply_filters( 'gas_checker_installation_notice', __( 'Gas Framework needs to be installed.', 'ayuda-help-desk' ) ) )
					. sprintf( " <a href='%s'>%s</a>",
						esc_url( admin_url( 'plugin-install.php?tab=search&type=term&s=gas+framework' ) ),
						esc_html( apply_filters( 'gas_checker_search_plugin_notice', __( 'Click here to search for the plugin.', 'ayuda-help-desk' ) ) )
					)
					. '</strong></p></div>';
				...
				echo "<div class='error'><p><strong>"
					. esc_html( apply_filters( 'gas_checker_activation_notice', __( 'Gas Framework needs to be activated.', 'ayuda-help-desk' ) ) )
					. sprintf( " <a href='%s'>%s</a>",
						esc_url( admin_url( 'plugins.php' ) ),
						esc_html( apply_filters( 'gas_checker_activate_plugin_notice', __( 'Click here to go to the plugins page and activate it.', 'ayuda-help-desk' ) ) )
					)
					. '</strong></p></div>';
			}
		}
