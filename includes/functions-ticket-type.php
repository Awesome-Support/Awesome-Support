...
function wpas_ticket_type_add_form_color_field( $taxonomy ) {
	...
	<div class="form-field term-color-wrap">
		<label for="term-color"><?php esc_html_e( 'Color', 'awesome-support' ); ?></label>
		<input type="text" name="term-color" id="term-color" value="" />
		<p class="description"><?php esc_html_e( 'Set ticket type color.', 'awesome-support' ); ?></p>
	</div>
...
function wpas_ticket_type_edit_form_color_field( $term, $taxonomy ) {
	...
	<tr class="form-field term-color-wrap">
		...
		<td>
			...
			<p class="description"><?php esc_html_e( 'Set priority color.', 'awesome-support' ); ?></p>
		</td>
	</tr>
