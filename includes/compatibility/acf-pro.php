<?php
/**
 * @package   Ayuda – Help Desk/Compatibility/ACF Pro
...
add_action( 'wp_print_scripts', 'mumei_ayuda_remove_acf_pro_select2_assets' );
/**
 * Fix compatibility issue with ACF Pro's select2
 *
 * ACF Pro uses select2, just like Ayuda – Help Desk. However, instead of loading select2's assets only where it is used
 * by ACF, they load the assets everywhere, which messes us with our own instances of select2 if the versions of
 * select2 used by Ayuda – Help Desk and ACF Pro don't match.
 *
 * @since 3.3.2
 * @return void
 */
function mumei_ayuda_remove_acf_pro_select2_assets() {
