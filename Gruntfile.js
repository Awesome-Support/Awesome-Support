...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		copy: {
		  vendoroverrides: {
			files: [
			  { src:"vendor-overrides/titan-framework-overrides/class-option-edd-license.php", dest:"vendor/tednh/titan-framework/lib/class-option-edd-license.php" },
			  { src:"vendor-overrides/titan-framework-overrides/EDD_SL_Plugin_Updater.php", dest:"vendor/tednh/titan-framework/inc/edd-licensing/EDD_SL_Plugin_Updater.php" },
